...
casename = 'all-6235:时间插件-右键'

class Dock_PluginDatetimeRightClick(unittest.TestCase):
    caseid = '283426'
    @classmethod
    def setUpClass(cls):
    ...
    def testPluginDatetimeRightClick(self):
    ...
    def suite():
        ...
        suite.addTest(Dock_PluginDatetimeRightClick('testPluginDatetimeRightClick'))
        return suite
...
if __name__ == "__main__":
    ...
    executeTestCase.runTest(Dock_PluginDatetimeRightClick)
