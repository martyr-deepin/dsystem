...
casename = "all-6201:时间插件隐藏和显示"

class Dock_PluginDatetime(unittest.TestCase):
    caseid = '280135'
    ...
    def testPluginDatetimeHide(self):
        ...
        pluginnetwork = self.dock.dockObj.child(self.dock.string_plugin_datetime)
        self.assertTrue(pluginnetwork == None)

    def testPluginDatetimeDisplay(self):
        self.assertTrue(self.dockp.hidemode_keepshowing ==
                self.daemondock.getHideMode())
        self.assertTrue(self.dockp.hidestate_show ==
                self.daemondock.getHideState())
    ...
    def suite():
        ...
        suite.addTest(Dock_PluginDatetime('testPluginDatetimeHide'))
        suite.addTest(Dock_PluginDatetime('testPluginDatetimeDisplay'))
        return suite
