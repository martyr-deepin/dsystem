...
casename = "all-6230:打开和关闭所有"

class Dock_IconMenuMultiClose(unittest.TestCase):
    caseid = '282485'
    @classmethod
    def setUpClass(cls):
        cls.dock = Dock()
    ...
    def suite():
        ...
        suite.addTest(Dock_IconMenuMultiClose('testOpenRun'))
...
if __name__ == "__main__":
    ...
    executeTestCase.runTest(Dock_IconMenuMultiClose)
