...
casename = 'all-5394:使用ping命令对本机地址的ping操作'

class Command_ping_local_ip(unittest.TestCase):
    caseid = '192167'
    @classmethod
    def setUpClass(cls):
        pass
    ...
    def suite():
        ...
        suite.addTest(Command_ping_local_ip('test_ping_local_ip'))
        return suite

if __name__ == "__main__":
    unittest.installHandler()
    executeTestCase.runTest(Command_ping_local_ip)
